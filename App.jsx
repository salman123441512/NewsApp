  ...
  render() {
    return (
      ...
      <Routes>
        ...
        <Route path='/Hindi' element={<Home search={this.state.search} language={this.state.language} q='Hindi' />}/>
        <Route path='/English' element={<Home search={this.state.search} language={this.state.language} q='English' />}/>
      </Routes>
      <Footer/>
      </BrowserRouter>
      </>
